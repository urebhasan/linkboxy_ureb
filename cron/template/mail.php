                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td
                                                              ...
                                                              <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;" alt="" data-proportionally-constrained="true" data-responsive="false" src="https://linkboxy.com/img/logo.png" height="37">
                                                            </td>
                                                          </tr>
                                                        </tbody>
                                                      </table>
                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td
                                                              ...
                                                              role="module-content">
                                                              <div>
                                                                <div style="font-family: inherit; text-align: center;color:#1188e6;">
                                                                  <span style="font-size: 43px">Your LinkBoxy Alert</span></div>
                                                                <div></div>
                                                              </div>
                                                            </td>
                                                          </tr>
                                                            ...
                                                            <td
                                                              ...
                                                              <div>
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span style="font-size: 18px;color:#1188e6;">Check the live dashboard here!</span><span
                                                          ...
                                                          <tr>
                                                            <td align="center" bgcolor="#ffffff" class="outer-td"
                                                              ...
                                                              <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tbody>
                                                                  <tr>
                                                                    <td align="center" bgcolor="#1188e6"
                                                                      class="inner-td"
                                                                      style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                                                                      <a href="https://app.linkboxy.com" id="loginbtn"
                                                                        style="background-color:#1188e6; border:1px solid #0075d2; border-color:#1188e6; border-radius:0px; border-width:1px; color:#FFFFFF; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;"
                                                          ...
                                                          <tr>
                                                            <td
                                                              ...
                                                              <div>
                                                                ...
                                                                <div style="font-family: inherit; text-align: center">
                                                                  <span
                                                                    style="color: #ffffff !important; font-size: 16px"><strong>List
                                                                      of alerts:</strong></span></div>
EOD;
...
<div data-role="module-unsubscribe" class="module" role="module" data-type="unsubscribe"
    ...
    <div class="Unsubscribe--addressLine">
        <p class="Unsubscribe--senderName" style="font-size:12px; line-height:20px;">LinkBoxy.com</p>
    </div>
    <p style="font-size:12px; line-height:20px;"><a id="unsubscribe" class="Unsubscribe--unsubscribeLink" href="https://app.linkboxy.com"
            target="_blank" style="">Unsubscribe</a></p>
</div>
<table border="0" cellpadding="0" cellspacing="0" class="module" data-role="module-button" data-type="button"
    role="module" style="table-layout:fixed;" width="100%" data-muid="550f60a9-c478-496c-b705-077cf7b1ba9a">
    <tbody>
        <tr>
